...
func (c *PreparerConfig) PrepareSecrets(h Hydrator) error {
	return h.HydrateFromFieldOrFile(&c.SecretField, c.SecretFieldFile)
}
...
`, secretFile)
	...
	_, cfg, _ := setupManagerTest[PreparerConfig](t, contents, &mockProvider{})
