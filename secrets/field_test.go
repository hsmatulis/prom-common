...
func TestSecretField_ManagerPanics(t *testing.T) {
	...
	assert.PanicsWithValuef(t, "secret field has not been discovered by a manager; was NewManager(&cfg) called?", func() { sf.SetSecretValidation(nil) }, "SetSecretValidation should panic without a manager")
